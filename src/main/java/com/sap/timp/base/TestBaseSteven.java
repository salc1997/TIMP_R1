...
public class TestBaseSteven  {
	...
	public String correcãoInativa = "A corre��o n�o foi ativada";
	...
	public String comentarioNãoValido = "Os coment�rios n�o foram os ingresados";
	...
	public String exportação = "A exporta��o n�o foi realizada com sucesso";
	public String filtros = "Os resultados do filtro n�o s�o iguais";
	public String aplicaçãoFiltros = "Os filtros n�o foram aplicados com sucesso";
	public String formatação = "A formata��o n�o foi aplicada";
	...
	public String visualizaçar = "O modo visualiza��o n�o est� ativado";
