package com.sap.timp.pageObjectModel.ADM.Configuracao.ConfiguracaoDeTributos.ConfiguracaoTributoXEstrutura;
...
public class ConfiguracaoTributoXEstruturaCriarPO extends TestBase{
	...
	public ConfiguracaoTributoXEstruturaCriarPO() {
	...
	public Boolean excluir() {
		...
		waitExpectedElement(Configuração);
		sleep(2000);
