package com.sap.timp.pageObjectModel.ADM.Configuração.ConfiguraçãoDeTributos.ConfiguraçãoDeTipoTributo;
...
public class ConfiguracaoDeTipoTributoFiltrosAvancadosPO extends TestBaseSteven{
	...
	public ConfiguracaoDeTipoTributoFiltrosAvancadosPO() {
