...
public class DemaisHierarquiaConfiguracaoTodasAsFuncionalidadesParte1PO extends TestBase  {
	//TSTNG-2230
...
//		sleep(2000);
		...
		int rowsH2 = driver.findElements(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id]")).size();
		String iH2 = driver.findElement(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id][" + rowsH2 + "]/div[4]/div")).getText();
		String nome = driver.findElement(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id][" + rowsH2 + "]/div[5]/div")).getText();
		System.out.println(nome);

		sucesso.add(nome.contains("Prueba Automatizada de Hierarq"));


		idInserir("DemaisHierarquiaConfiguracaoH1",iH2);
		System.out.println("Id  Hierarquia creada: " + iH2);
	...
	public boolean criarConfiguracionConfiguracao() {
		...
		idInserir("DemaisHierarquiaConfiguracaoC1",idApos);
	...
	public ArrayList<Boolean> configurarConfiguracao() {
		...
		sleep(2000);
		WebElement menu = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("DemaisHierarquiaConfiguracaoC1")+"\"]/div[1]/div"));
		WebElement editar = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("DemaisHierarquiaConfiguracaoC1")+"\"]/div[1]/div/div[2]/ul/li/span[text()=\"Editar\"]"));
		sleep(2000);
...
//		sleep(2000);
		...
		System.out.println(" segunda hierarquia a excluir: "+idH4);
		idInserir("DemaisHierarquiaConfiguracaoH2",idH4);
	...
	public boolean criarConfiguracionConfiguracao2() {
		...
		idInserir("DemaisHierarquiaConfiguracaoC2",idAposC2);
	...
	public ArrayList<Boolean> configurarConfiguracaoRelacionamiento() {
		...
		WebElement menu = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("DemaisHierarquiaConfiguracaoC2")+"\"]/div[1]/div"));
		WebElement editar = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("DemaisHierarquiaConfiguracaoC2")+"\"]/div[1]/div/div[2]/ul/li/span[text()=\"Editar\"]"));
		sleep(2000);
	...
	public ArrayList<Boolean> relacionamentoTotalizadorSubperiodoFixoReplicar() {
		...
		WebElement opcConfiguracaoConsolidacao = driver.findElement(By.xpath("//li[contains(text(),\""+idObter("DemaisHierarquiaConfiguracaoC1")+"\")]"));
...
//		sleep(2000);
		...
		WebElement opcConfiguracaoConsolidacao2 = driver.findElement(By.xpath("//li[contains(text(),\""+idObter("DemaisHierarquiaConfiguracaoC1")+"\")]"));
