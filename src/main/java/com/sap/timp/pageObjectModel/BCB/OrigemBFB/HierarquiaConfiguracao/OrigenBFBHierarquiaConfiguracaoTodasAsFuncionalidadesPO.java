...
public class OrigenBFBHierarquiaConfiguracaoTodasAsFuncionalidadesPO extends TestBase{
...
//		sleep(2000);
	...
	public ArrayList<Boolean> configurarConfiguracao() {
		...
		WebElement menu = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("OrigenBFBC1")+"\"]/div[1]/div"));
		WebElement editar = driver.findElement(By.xpath("//div[@class=\"tr\" and @data-id=\""+idObter("OrigenBFBC1")+"\"]/div[1]/div/div[2]/ul/li/span[text()=\"Editar\"]"));
		sleep(2000);
...
//		sleep(3000);
	...
	public ArrayList<Boolean> abrirSubnivel2() {
		...
		if (tc2==true) {
			...
			sucesso.add(valorCampoPeriodoTiempoSubNivel2.contains("01/2014 - 1Y"));
		}else {
			sucesso.add(valorCampoSaidaSubNivel2.equals("5.000,00"));
	...
	public ArrayList<Boolean> excluirConfiguracoes() {
		...
		String idConfiguracao = idObter("OrigenBFBC1");
		System.out.println("");
...
//		sleep(2000);
	...
	public ArrayList<Boolean> excluirHierarquia() {
		...
		String idHierarquia = idObter("OrigenBFBH1");
