...
public class ParametrosGeraisConfiguraçãoCriarPO extends TestBaseCristhian {
	...
	public ParametrosGeraisConfiguraçãoCriarPO() {
	...
	public ArrayList<Boolean> criarConfiguracao() {
		...
		nomeHirarquia.sendKeys("183 - Super Basica");
		sleep(1000);
