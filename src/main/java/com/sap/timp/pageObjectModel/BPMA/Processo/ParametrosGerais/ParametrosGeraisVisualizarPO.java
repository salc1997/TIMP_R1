...
public class ParametrosGeraisVisualizarPO extends TestBaseSteven{
...
*/
		...
		WebElement menu = driver.findElement(By.xpath("//div[@data-id=\""+idV+"\"]/div[1]/div"));
		WebElement açao = driver.findElement(By.xpath("//div[@data-id=\""+idV+"\"]/div[1]/div/div[2]/ul/li/span[text()=\"Visualizar \"]"));
