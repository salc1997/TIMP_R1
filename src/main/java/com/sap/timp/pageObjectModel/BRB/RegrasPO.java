...
public class RegrasPO extends TestBase{
	...
	public boolean regra() {
		...
		waitExpectedElement("/html/body/div[3]/div/div[2]/div/div[2]/div/div/div/div[2]/div[1]/div[1]/label/span");
		sleep(1000);
		selecionRegra.click();
		sleep(1000);
		...
		waitExpectedElement("/html/body/div[3]/div/div[2]/div/div[2]/div[2]/div/div/div/div/div[2]/div[1]/div[1]/label/span");
		sleep(1000);
		proximo.click();
