...
public class NFsEntradaSaidaeDadosComplementaresPO extends TestBase{
	...
	public ArrayList<Boolean> verificar() {
		...
		double esperadovalorLiquido = 0;
		System.out.println(esperadovalorLiquido + " Esperado");
		sucesso.add(mayorQue(valorLiquidoD, esperadovalorLiquido));
		System.out.println(mayorQue(valorLiquidoD, esperadovalorLiquido) + " Valor Liquido");
		System.out.println("-------------------------------------------------");
		...
		double esperadovalorTotalDocFiscal = 0;
		sucesso.add(mayorQue(valorTotalDocFiscalD, esperadovalorTotalDocFiscal));
		System.out.println(esperadovalorTotalDocFiscal + " Esperado");
		System.out.println(mayorQue(valorTotalDocFiscalD, esperadovalorTotalDocFiscal) +" Valor Total Doc Fiscal");
