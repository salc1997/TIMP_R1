...
public class CalculodeTributosSimularPO extends TestBaseCristhian {
	...
	public CalculodeTributosSimularPO() {
...
//	Regras.click();
	...
	WebElement açao = driver.findElement(By.xpath("//div[@data-id=\""+idRegistro+"\"]/div[1]/div/div[2]/ul/li/span[text()=\"Simular\"]"));
