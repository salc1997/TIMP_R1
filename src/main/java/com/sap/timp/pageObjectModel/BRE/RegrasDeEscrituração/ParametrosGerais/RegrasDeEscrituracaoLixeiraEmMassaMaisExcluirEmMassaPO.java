...
public class RegrasDeEscrituracaoLixeiraEmMassaMaisExcluirEmMassaPO extends TestBase{
	...
	public ArrayList<Boolean> criar() {
		...
		nome.click();
		sleep(1000);
		nome.sendKeys("TA-TESTE Escrituracao 1 - NÃO MEXER QA");
		sleep(1000);
		...
		nome.click();
		sleep(1000);
		nome.sendKeys("TA-TESTE Escrituracao 2- NÃO MEXER QA");
		sleep(1000);
