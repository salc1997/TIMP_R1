...
public class RegrasDeMensagensLixeiraEmMassaMaisExcluirEmMassaPO extends TestBase{
	...
	public RegrasDeMensagensLixeiraEmMassaMaisExcluirEmMassaPO() {
	...
	public ArrayList<Boolean> criar() {
		...
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		waitExpectedElement(regrasdemensagens);
		sleep(2000);
		regrasdemensagens.click();
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
