...
public class RegrasDeNegocioLixeiraEmMassaMaisExcluirEmMassaPO extends TestBaseSteven {
	...
	public ArrayList<Boolean> criar() {
		...
		nome.click();
		sleep(1000);
		nome.sendKeys("TESTE AUTOMATIZADO Negocio 1 - NAO MEXER");
		sleep(1000);
		...
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		waitExpectElement(regrasdenegocio);
		sleep(2000);
		regrasdenegocio.click();
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		...
		nome.click();
		sleep(1000);
		nome.sendKeys("TESTE AUTOMATIZADO Negocio 2 - NAO MEXER");
		sleep(1000);
