...
public class CorreçãodeNFRejeitarEmMassaPO extends TestBaseSteven {
	...
	public CorreçãodeNFRejeitarEmMassaPO() {
	...
	public ArrayList<Boolean> Rejeitar(){
		...
		System.out.println("Número de Id Segundo  dato Enviado: "+ idRegistro2);
		...
		boolean sucesso2 = (valor1.equals(idNotaFiscal2));
		sucesso2 = (valor2.equals(idNotaFiscal1));
		...
		String idRegistro2R = driver.findElement(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id]["+rows+"]/div[3]/div")).getText();

		System.out.println("Número de Id Segundo  dato Enviado: "+ idRegistro2R);

		ArrayList<Boolean> sucesso3 = new ArrayList<Boolean>();
		sucesso3.add(idRegistro1R.equals(idRegistro1));
		sucesso3.add(idRegistro2R.equals(idRegistro2));
