...
public class TarefasAdicionarComentárioPO extends TestBaseMassiel{
	...
	@FindBy(xpath = "//div[@class=\"dialog-buttons\"]/button[text()=\"Cancelar\"]")
	...
	//para utilizar despues de pesquisar
		...
		public TarefasAdicionarComentárioPO() {
		...
		public ArrayList<Boolean> criarProceso() {
			...
			nome.sendKeys("PRUEBA TESTEAUTOMATIZADO Adicionar comentário");
			sleep(2000);
			...
			nomeTarefa.sendKeys("Adicionar comentário");
			sleep(2000);
			...
			sucesso.add(nomeProceso.contains("PRUEBA TESTEAUTOMATIZADO Adicionar comentário"));
			...
			sucesso.add(nomeAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO Adicionar comentário"));
			sucesso.add(procesoNegocioAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO Adicionar comentário"));
		...
		public  ArrayList<Boolean> irCalendario() {
			...
			pesquisarBPMA.sendKeys("Adicionar comentário");
			sleep(2000);
			...
			sucesso.add(nombreProce1.contains("PRUEBA TESTEAUTOMATIZADO Adicionar comentário"));
			sucesso.add(nome1.equals("Adicionar comentário"));
			...
			WebElement comentario = driver.findElement(By.xpath("//div[@data-id][1]/div[2]/div/div[2]/ul/li/span[text()=\"Adicionar comentário\"]"));
			...
			textMensaje.sendKeys(" teste adicionar comentário");
			sleep(2000);
			...
			WebElement comentario2 = driver.findElement(By.xpath("//div[@data-id][1]/div[2]/div/div[2]/ul/li/span[text()=\"Adicionar comentário\"]"));
			...
			String comen1 = driver.findElement(By.xpath("//div[@class=\"comments-wrapper\"]/div[2]/div[1]/div")).getText();
			System.out.println("Status 1:  "+ comen1); 
			
			String fecha = fechaActual();
			System.out.println(fecha ); 
			
			sucesso.add(comen1.contains("TESTEAUTOMATIZADO | "+ fecha));
