...
public class TarefasAdicionarLinkPO extends TestBase{
	...
	//para utilizar despues de pesquisar
		...
		@FindBy(xpath = "//div[@class=\"dialog-content big\"]/div/div[2]/div/div/input")
		public WebElement textMensaje;
		...
		public ArrayList<Boolean> criarProceso() {
			...
			nome.sendKeys("PRUEBA TESTEAUTOMATIZADO ADICIONAR LINK");
			sleep(2000);
			...
			nomeTarefa.sendKeys("Adicionar Link");
			sleep(2000);
			...
			sucesso.add(nomeProceso.contains("PRUEBA TESTEAUTOMATIZADO ADICIONAR LINK"));
			...
			sucesso.add(nomeAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO ADICIONAR LINK"));
			sucesso.add(procesoNegocioAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO ADICIONAR LINK"));
		...
		public  ArrayList<Boolean> irCalendario() {
			...
			sucesso.add(nombreProce1.contains("PRUEBA TESTEAUTOMATIZADO ADICIONAR LINK"));
			sucesso.add(nome1.equals("Adicionar Link"));
			...
			textMensaje.sendKeys("www.google.com.br");
			sleep(2000);
			...
			WebElement menu2 = driver.findElement(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id][1]/div[2]/div"));
			...
			String link1 = driver.findElement(By.xpath("//div[@class=\"baseTabs-view -view-wrapper  selected\"]/div/div/div[9]/div/div/span[1]")).getText();
			System.out.println("Status 1:  "+ link1); 
			
			String link2 = driver.findElement(By.xpath("//div[@class=\"baseTabs-view -view-wrapper  selected\"]/div/div/div[9]/div/div/span[2]")).getText();
			link2 = link2.replace("0","");
			System.out.println("Status 1:  "+ link2);
			
			String url = driver.findElement(By.xpath("//div[@class=\"baseTabs-view -view-wrapper  selected\"]/div/div/div[9]/div/p[1]")).getText();
			...
			sucesso.add(link1.contains("TESTEAUTOMATIZADO"));
			sucesso.add(link2.contains(fecha));
			sucesso.add(url.contains("www.google.com.br"));
