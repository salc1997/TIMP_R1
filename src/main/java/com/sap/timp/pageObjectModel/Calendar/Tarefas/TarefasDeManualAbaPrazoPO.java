...
public class TarefasDeManualAbaPrazoPO extends TestBaseMassiel{
	...
	//editar tarefa
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[1]/div[3]/div/div[2]")
	public WebElement prazo;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[1]/ul/li/div/span[1]")
	public WebElement deadline;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[1]/ul/li/ul/li/div/div")
	public WebElement opcao;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[2]/div[2]/div[1]/div[1]/div/label/span")
	public WebElement diaEspecifico;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[1]/div/div/div[2]/div/div[1]/div[2]")
	public WebElement prazoComb;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[2]/div[2]/div[1]/div[2]/div/div[2]")
	public WebElement tipoDia;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[2]/div[2]/div[2]/div[2]/div/div[2]")
	public WebElement dia;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[2]/div[2]/div[3]/div[2]/div/div[2]")
	public WebElement periodo;
	
	@FindBy(xpath = "//div[@class=\"base-dialog create-rule-dialog  wide ui-draggable\"]/div[2]/div/div/div[2]/div/div[2]/div/div[2]/div/div/div[11]/div/div/div[2]/div/div/div/div[2]/div[2]/div[4]/div[2]/div/div[2]")
	...
	public ArrayList<Boolean> criarProceso() {
		...
		nomeTarefa.sendKeys("Tarefas de manual - aba prazo massiel");
		sleep(2000);
		...
		if (tq1 == true) {
			...
			WebElement tipoDiaOPC = driver.findElement(By.xpath("//li[@id=\"1\"]"));
			...
			WebElement tipoDiaOPC = driver.findElement(By.xpath("//li[@id=\"option-1\"]"));
		...
		if (tq1 == true) {
			...
			WebElement DiaOPC = driver.findElement(By.xpath("//li[@id=\"2\"]"));
			...
			WebElement DiaOPC = driver.findElement(By.xpath("//li[@id=\"option-3\"]"));
		...
		if (tq1 == true) {
			...
			WebElement DiaOPC = driver.findElement(By.xpath("//li[@id=\"1\"]"));
			...
			WebElement DiaOPC = driver.findElement(By.xpath("//li[@id=\"option-2\"]"));
		...
		public  ArrayList<Boolean> irCalendario() {
			...
			sucesso.add(nome1.equals("Tarefas de manual - aba prazo massiel"));
			...
			System.out.println("Dia creada Tarefa: "+diaTarefa1);
			WebElement diaTarefaCalendario1 = driver.findElement(
					By.xpath("//div[@class=\"dates-wrapper\"]/div[@date=\""+diaTarefa1+"\"][1]"));
		
		
			diaTarefaCalendario1.click();
			sleep(2000);
			invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
			sleep(2000);
