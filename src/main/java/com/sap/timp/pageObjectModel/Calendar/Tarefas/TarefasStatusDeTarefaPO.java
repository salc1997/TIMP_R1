...
public class TarefasStatusDeTarefaPO extends TestBaseSteven{
	...
	//para utilizar despues de pesquisar
		...
		@FindBy(xpath = "//span[text()=\"Aprovar\"]")
		...
		public TarefasStatusDeTarefaPO() {
		...
		public ArrayList<Boolean> criarProceso() {
			...
			nome.sendKeys("PRUEBA TESTEAUTOMATIZADO STATUS DE TAREFAS  MASSIEL");
			sleep(2000);
			...
			nomeTarefa.sendKeys("Status da Tarefa Massiel4");
			sleep(2000);
			...
			sucesso.add(nomeProceso.contains("PRUEBA TESTEAUTOMATIZADO STATUS DE TAREFAS MASSIEL"));
			...
			sucesso.add(nomeAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO STATUS DE TAREFAS MASSIEL"));
			sucesso.add(procesoNegocioAtivadorProcesos2.contains("PRUEBA TESTEAUTOMATIZADO STATUS DE TAREFAS MASSIEL"));
		...
		public  ArrayList<Boolean> irCalendario() {
			...
			sucesso.add(nombreProce1.contains("PRUEBA TESTEAUTOMATIZADO STATUS DE TAREFAS"));
			sucesso.add(nome1.equals("Status da Tarefa Massiel4"));
			...
			System.out.println("Status :  "+ status11); 
