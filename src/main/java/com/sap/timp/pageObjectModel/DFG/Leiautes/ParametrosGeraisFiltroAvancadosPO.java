...
public class ParametrosGeraisFiltroAvancadosPO extends TestBaseMassiel{
	...
	String textVersao = "1.0"  ;
	String textNome = "Teste Automatizado";
	...
	public void Filtro() {
		...
		WebElement menu = driver.findElement(By.xpath("//div[@data-id=\""+idRegistro+"\"]"));
		    ...
		    textId = driver
				.findElement(By.xpath("//div[@id=\"libraryview\"]/div/div[1]/div/div[3]/div[@data-id=\""+idRegistro+"\"]/div[5]"))		   
				.getText();
