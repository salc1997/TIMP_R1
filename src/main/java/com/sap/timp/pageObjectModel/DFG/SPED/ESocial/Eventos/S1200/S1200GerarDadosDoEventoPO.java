...
public class S1200GerarDadosDoEventoPO extends TestBase{
	...
	public ArrayList<Boolean> verificacaoInsert() {
		...
		WebElement acao = driver.findElement(By.xpath("//div[@data-id=\"8\" and @class=\"tr\"]/div[1]/div/div[2]/ul/li/span[text()=\"Informação\"]"));
