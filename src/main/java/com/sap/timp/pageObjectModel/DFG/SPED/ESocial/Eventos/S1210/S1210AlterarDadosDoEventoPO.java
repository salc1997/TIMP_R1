...
public class S1210AlterarDadosDoEventoPO extends TestBaseFernando{
	...
	public ArrayList<Boolean> informacao() {
		...
		WebElement açao = driver.findElement(
				By.xpath("//div[@data-id=\"" + idRegistro + "\"]/div[1]/div/div[2]/ul/li/span[text()=\"Informação\"]"));
		...
		// Datos informacao
		String nomeInformacao = driver.findElement(By.xpath("//div[@id=\"detail-description\"][2]/div[2]/div"))
				.getText();
		String descricaoInformacao = driver.findElement(By.xpath("//div[@id=\"detail-description\"][3]/div[2]/div"))
				.getText();
	...
	public boolean editar() {
		...
		WebElement btnCerrarMensaje = driver
				.findElement(By.xpath("//span[@class=\"close icon icon-font-Sign-and-Symbols icon-persign\"]"));
		...
		this.empresaString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"company-select\")]/div/div/div/div/div/div[1]"))
				.getText();
		this.ufString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"uf-select\")]/div/div/div/div/div/div[1]")).getText();
		this.filialString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"branch-select\")]/div/div/div/div/div/div[1]"))
				.getText();
	...
	public ArrayList<Boolean> visualizar() {
		...
		String leiauteString = driver.findElement(By.xpath("//div[contains(@class, \"layout-select\")]/div/div/input"))
				.getAttribute("value");
		String versaoLeiauteString = driver
				.findElement(By.xpath("//div[contains(@class, \"version-select\")]/div/div/div/input"))
				.getAttribute("value");
		String tributoString = driver.findElement(By.xpath("//div[contains(@class, \"tax-select\")]/div/div/input"))
				.getAttribute("value");
		String empresaString = driver
				.findElement(By.xpath("//div[contains(@class, \"company-select\")]/div/div/div/div/div/div[1]"))
				.getText();
		String ufString = driver
				.findElement(By.xpath("//div[contains(@class, \"uf-select\")]/div/div/div/div/div/div[1]")).getText();
		String filialString = driver
				.findElement(By.xpath("//div[contains(@class, \"branch-select\")]/div/div/div/div/div/div[1]"))
				.getText();
		String dataInicioVigenciaString = driver
				.findElement(By.xpath("//div[contains(@class, \"valid-from-select\")]/div/div/input"))
				.getAttribute("value");
		...
		String leiauteString1 = driver.findElement(By.xpath("//div[contains(@class, \"layout-select\")]/div/div/input"))
				.getAttribute("value");
		String versaoLeiauteString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"version-select\")]/div/div/div/input"))
				.getAttribute("value");
		String tributoString1 = driver.findElement(By.xpath("//div[contains(@class, \"tax-select\")]/div/div/input"))
				.getAttribute("value");
		String empresaString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"company-select\")]/div/div/div/div/div/div[1]"))
				.getText();
		String ufString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"uf-select\")]/div/div/div/div/div/div[1]")).getText();
		String filialString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"branch-select\")]/div/div/div/div/div/div[1]"))
				.getText();
		String dataInicioVigenciaString1 = driver
				.findElement(By.xpath("//div[contains(@class, \"valid-from-select\")]/div/div/input"))
				.getAttribute("value");
	...
	public boolean gravar() {
		...
		String mensajeSucesso = driver
				.findElement(By.xpath("//li[@class=\"base-toast  toast-success   \"]/div/span[2]/span")).getText();
	...
	public boolean visualizarCriarAN3() {
		...
		boolean regrasExecutroElement = driver.findElement(By.xpath("//div[@class=\"executor-wrapperan3\"]"))
				.isDisplayed();
		boolean sucesso = false;
	...
	public ArrayList<Boolean> gravarAN3() {
		...
		int rows = driver
				.findElements(By.xpath(
						"//div[contains(@class, \"tbody\")]/div[@class=\"tr\" and @data-id and @tabindex=\"0\"]"))
				.size();

		String nomeString = driver.findElement(By.xpath(
				"//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id][" + rows + "]/div[7]/div"))
				.getText();
		String descricaoString = driver.findElement(By.xpath(
				"//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id][" + rows + "]/div[8]/div"))
				.getText();
		String empresaString = driver
				.findElement(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id]["
						+ rows + "]/div[10]/div"))
