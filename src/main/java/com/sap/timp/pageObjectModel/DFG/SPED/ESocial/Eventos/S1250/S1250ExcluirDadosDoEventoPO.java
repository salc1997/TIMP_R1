...
public class S1250ExcluirDadosDoEventoPO extends TestBase{
	...
	public WebElement s1250AcquisitionOfRuralProduction;

	@FindBy(xpath = "//li[@identifier=\"accordion-item-s1250\"]/ul/li[@identifier=\"accordion-item-scanc-calculationBlocks\"]/div/span[text()=\"Excluir Dados do Evento\"]")
	...
	@FindBy(xpath = "//li[@identifier=\"accordion-item-s1250-delete\"]")
	public WebElement s1250Exclusion;
	...
	public S1250ExcluirDadosDoEventoPO() {
	...
	public boolean criarNovoEvento() {
		...
		eventos.click();
		sleep(1000);
		s1250AcquisitionOfRuralProduction.click();
		sleep(1000);
		actionsMoveToElement(excluirDadosDoEvento);
		...
		idInserir("excluirDadosDoEventoS1250",idB);
	...
	public ArrayList<Boolean> informacao() {
		...
		String idRegistro = idObter("excluirDadosDoEventoS1250");
		System.out.println("");
	...
	public ArrayList<Boolean> informacao2() {
		...
		s1250AcquisitionOfRuralProduction.click();
		sleep(1000);
		actionsMoveToElement(s1250Exclusion);
		s1250Exclusion.click();
		sleep(2000);
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
