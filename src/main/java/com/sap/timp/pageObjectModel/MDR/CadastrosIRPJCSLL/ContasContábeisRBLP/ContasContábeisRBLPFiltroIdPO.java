package com.sap.timp.pageObjectModel.MDR.CadastrosIRPJCSLL.ContasContábeisRBLP;
...
public class ContasContábeisRBLPFiltroIdPO extends TestBaseSteven{
	
	@FindBy(xpath = "//span[text()=\"Cadastros IRPJ/CSLL\"]")
	public WebElement cadastro;
	
	@FindBy(xpath = "//span[text()=\"Contas Contábeis RB/LP\"]")
	...
	public ContasContábeisRBLPFiltroIdPO() {
