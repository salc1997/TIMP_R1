...
public class CadastroMotivosReaberturaExcluirEmMassaPO extends TestBaseSteven{
	...
	public CadastroMotivosReaberturaExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		descricao.sendKeys("Teste Cadastro de Motivos de Reabertura 1");
		sleep(1000);
		...
		codigo.sendKeys("9876543210");
		sleep(1000);

		descricao.sendKeys("Teste Cadastro de Motivos de Reabertura 2");
		sleep(1000);
