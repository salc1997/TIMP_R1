...
public class ContasDefaultPorTributoVisualizarPO extends TestBaseEliel{
	...
	public String visualizar() {
		...
		String sucesso = driver.findElement(By.xpath("//div[@class=\"formBuilder-wrapper\"]")).getAttribute("class");
