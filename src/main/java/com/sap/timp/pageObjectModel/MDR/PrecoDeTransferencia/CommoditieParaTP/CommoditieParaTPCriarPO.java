...
public class CommoditieParaTPCriarPO extends TestBaseMassiel{
	...
	public boolean Criar() {
		...
		sleep(2000);
		commodine.sendKeys("98676217");invisibilityOfElement("//div[@class=\\\"overlay loader dark\\\"]");
		
		sleep(2000);
		tipo.sendKeys("33726668");invisibilityOfElement("//div[@class=\\\"overlay loader dark\\\"]");
