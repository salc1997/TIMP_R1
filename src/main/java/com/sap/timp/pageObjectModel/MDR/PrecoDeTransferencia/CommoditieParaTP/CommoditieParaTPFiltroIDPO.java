...
public class CommoditieParaTPFiltroIDPO extends TestBase {

	@FindBy(xpath = "//li/div/span[text()=\"Preço de Transferência\"]")
	public WebElement precoTransferencia;
	@FindBy(xpath = "//li/div/span[text()=\"Commoditie para TP\"]")
	public WebElement commoditie;
	...
	public CommoditieParaTPFiltroIDPO() {
