...
public class ValoresParaMetodoCAPExcluirEmMassaPO extends TestBaseSteven{
	...
	public ValoresParaMetodoCAPExcluirEmMassaPO() {
	...
	public boolean valoresParaMetodoCAPExcluirEmMassa() {
		int rows = driver.findElements(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id]")).size();
