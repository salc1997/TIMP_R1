...
public class ValoresParaMetodoCAPFiltroIDPO extends TestBase {
	...
	@FindBy(xpath = "//li/div/span[text()=\" Valores para Método CAP\"]")
	...
	public ValoresParaMetodoCAPFiltroIDPO() {
