...
public class ValoresParaMetodoPECEXDetalhesPO extends TestBaseEliel {
	...
	@FindBy(xpath = "//span[@id=\"exportDate\"]")
	public WebElement dataexportacaovi;
	...
	public ValoresParaMetodoPECEXDetalhesPO() {
	...
	public ArrayList<Boolean> detalhes() {
		...
		String dataexportacaodetalhes = dataexportacao.getText();
		...
		System.out.println(dataexportacaodetalhes);
		...
		sleep(2000);
		//pega o ultimo id que foi gerado no criar
		String idRegistro1 = idObter("ValoresParaMetodoPECEX");
		...
		String dataexportacaovisualizar = dataexportacaovi.getText();
		...
		System.out.println(dataexportacaovisualizar);
		...
		sucesso.add( dataexportacaovisualizar.equals(dataexportacaodetalhes));
