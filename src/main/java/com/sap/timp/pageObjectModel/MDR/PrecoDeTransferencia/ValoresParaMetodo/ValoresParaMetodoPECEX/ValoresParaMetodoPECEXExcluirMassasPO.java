...
public class ValoresParaMetodoPECEXExcluirMassasPO extends TestBaseFernando{
	...
	public boolean criar() {
		...
		idInserir("ValoresParaMetodoPECEX", idPrimerRegistro);
	...
	public boolean exluirMassa() {
		...
		int idPrimerRegistro = convertToInt(idObter("ValoresParaMetodoPECEX"));
