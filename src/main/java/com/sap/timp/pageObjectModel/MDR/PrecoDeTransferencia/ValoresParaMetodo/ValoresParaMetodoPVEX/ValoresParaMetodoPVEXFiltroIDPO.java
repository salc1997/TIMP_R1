...
public class ValoresParaMetodoPVEXFiltroIDPO extends TestBase {
	...
	@FindBy(xpath = "//li/div/span[text()=\" Valores para Método PVEX\"]")
	...
	public ValoresParaMetodoPVEXFiltroIDPO() {
