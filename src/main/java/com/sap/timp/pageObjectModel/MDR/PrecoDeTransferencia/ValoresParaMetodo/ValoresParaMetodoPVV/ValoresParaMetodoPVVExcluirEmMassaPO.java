...
public class ValoresParaMetodoPVVExcluirEmMassaPO extends TestBaseSteven{
	...
	public ValoresParaMetodoPVVExcluirEmMassaPO() {
	...
	public boolean valoresParaMetodoPVVExcluirEmMassa() {
		int rows = driver.findElements(By.xpath("//div[contains(@class,\"tbody\")]/div[contains(@class,\"tr\") and @data-id]")).size();
