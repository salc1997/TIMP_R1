...
public class RelacionamentoEntreQuadrosExcluirPO extends TestBaseSteven{
	
	@FindBy(xpath = "//span[text()=\"SCANC\"]")
	public WebElement scanc;
	
	@FindBy(xpath = "//span[text()=\"Relacionamento entre Quadros\"]")
	public WebElement relacionamientoEntreCuadros;
	...
	public RelacionamentoEntreQuadrosExcluirPO() {
	...
	public Boolean excluir() {
		...
		relacionamientoEntreCuadros.click();
		sleep(2000);
