...
public class SPCBFederaisRetidosCriarPO extends TestBaseCristhian{
	...
	*/
	...
	public SPCBFederaisRetidosCriarPO() {
	...
	public boolean criar() {
		...
		beneficiario.sendKeys("Tester QA");
		sleep(1000);
		...
		idInserir("SPCBFederaisRetidos",idB);
		sleep(2000);
