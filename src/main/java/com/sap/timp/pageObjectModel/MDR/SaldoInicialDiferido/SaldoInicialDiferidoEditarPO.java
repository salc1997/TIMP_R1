...
public class SaldoInicialDiferidoEditarPO extends TestBase {
	...
	@FindBy(xpath = "//input[contains(@placeholder,\"Saldo\")]")
	...
	public SaldoInicialDiferidoEditarPO() {
	...
	public boolean editar() {
		...
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		String idRegistro = idObter("SaldoInicialDiferido");
