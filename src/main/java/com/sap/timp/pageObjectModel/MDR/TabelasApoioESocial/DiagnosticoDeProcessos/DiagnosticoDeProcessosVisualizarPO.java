...
public class DiagnosticoDeProcessosVisualizarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//span[text()=\"Novo Código\"]")
	...
	@FindBy(xpath = "//td[@id=\"codeDescription\"]/span")
	...
	public DiagnosticoDeProcessosVisualizarPO() {
...
public ArrayList<Boolean> visualizar() {
		...
		//pega o ultimo id que foi gerado no criar
		String idRegistro1 = idObter("DiagnosticoDeProcessos");
