...
public class CategoriaDeTrabalhadoresExcluirMassaPO extends TestBaseCristhian {
	...
	@FindBy(xpath = "//button/span[contains(text(),\"Nova Categoría de Trabalhador\")]")
	public WebElement novo;
	
	@FindBy(xpath = "//input[contains(@placeholder,\"Código\")]")
	public WebElement codigo;
	
	@FindBy(xpath = "//input[contains(@placeholder,\"Preencher Grupo\")]")
	...
	*/
	...
	public CategoriaDeTrabalhadoresExcluirMassaPO() {
	...
	public boolean criar() {
		...
		codigo.sendKeys("113");
		sleep(1000);
		descricao.sendKeys("Descripcion Test de QA 2");
		sleep(1000);
