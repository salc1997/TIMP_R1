...
public class CategoriasDeTrabalhadoresCriarPO extends TestBaseEliel {
	...
	public CategoriasDeTrabalhadoresCriarPO() {
	...
	public boolean criar() {
		...
		idInserir("CategoriasDeTrabalhadores",idB);
