...
public class FinanciamentoDeAposEspVisualizarPO extends TestBase {
	...
	public FinanciamentoDeAposEspVisualizarPO() {
...
public ArrayList<Boolean> visualizar() {
		...
		//pega o ultimo id que foi gerado no criar
		String idRegistro1 = idObter("FinanciamentoDeAposEsp");
