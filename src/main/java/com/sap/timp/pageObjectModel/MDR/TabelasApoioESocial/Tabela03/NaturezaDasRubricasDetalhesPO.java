...
public class NaturezaDasRubricasDetalhesPO extends TestBaseSteven{
	...
	public NaturezaDasRubricasDetalhesPO() {
	...
	public ArrayList<Boolean> detalhes() {
		...
		String nome = driver.findElement(By.xpath("//div[@class=\"detail-data\"]/div[3]/div/div")).getText().trim();
		...
		System.out.println("Nome natureza: " + nome);
		...
		String nome1 = driver.findElement(By.xpath("//td[@id=\"natureName\"]/span")).getText().trim();
		...
		System.out.println("Nome natureza: " + nome1);
