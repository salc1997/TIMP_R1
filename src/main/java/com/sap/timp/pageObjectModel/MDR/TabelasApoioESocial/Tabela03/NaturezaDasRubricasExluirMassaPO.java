...
public class NaturezaDasRubricasExluirMassaPO extends TestBaseSteven{
	...
	public NaturezaDasRubricasExluirMassaPO() {
	...
	public boolean criar() {
		...
		natureza.sendKeys("Natureza 2");
		sleep(1000);
		
		descricao.sendKeys("Teste da Descrição 2");
		sleep(1000);
		...
		idInserir("NaturezaDasRubricasExcluirMassa",idUltimoRegistro);
	...
	public boolean exluirMassa() {
		...
		int idUltimoRegistro = convertToInt(idObter("NaturezaDasRubricasExcluirMassa"));
