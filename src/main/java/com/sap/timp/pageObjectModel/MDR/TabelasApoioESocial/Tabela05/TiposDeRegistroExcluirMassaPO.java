...
public class TiposDeRegistroExcluirMassaPO extends TestBaseSteven{
	...
	public TiposDeRegistroExcluirMassaPO() {
	...
	public boolean criar() {
		...
		idInserir("TiposDeRegistroExcluirMassa",idUltimoRegistro);
	...
	public boolean exluirMassa() {
		...
		int idUltimoRegistro = convertToInt(idObter("TiposDeRegistroExcluirMassa"));
