...
public class PaisesExcluirMassaPO extends TestBaseFernando{
	...
	public boolean criar() {
		...
		idInserir("PaisesExcluirMassa",idUltimoRegistro);
	...
	public boolean exluirMassa() {
		...
		int idUltimoRegistro = convertToInt(idObter("PaisesExcluirMassa"));
