...
public class TiposDeDependentesExcluirMassaPO extends TestBaseSteven{
	...
	public boolean criar() {
		...
		idInserir("TiposDeDependentesExcluirMassa",idUltimoRegistro);
	...
	public boolean exluirMassa() {
		...
		int idUltimoRegistro = convertToInt(idObter("TiposDeDependentesExcluirMassa"));
