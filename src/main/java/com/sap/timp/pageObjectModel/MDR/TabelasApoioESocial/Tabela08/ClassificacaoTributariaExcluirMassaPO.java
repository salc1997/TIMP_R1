...
public class ClassificacaoTributariaExcluirMassaPO extends TestBaseSteven{
	...
	public ClassificacaoTributariaExcluirMassaPO() {
	...
	public boolean criar() {
		...
		idInserir(" ClassificacaoTributariaExcluirMassa",idUltimoRegistro);
	...
	public boolean exluirMassa() {
		...
		int idUltimoRegistro = convertToInt(idObter(" ClassificacaoTributariaExcluirMassa"));
