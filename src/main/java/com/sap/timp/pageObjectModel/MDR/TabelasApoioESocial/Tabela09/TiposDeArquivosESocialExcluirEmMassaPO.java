...
public class TiposDeArquivosESocialExcluirEmMassaPO extends TestBase{
	...
	public TiposDeArquivosESocialExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		eventos.sendKeys("Teste Tipo de Arquivo e-Social 1");
		sleep(1000);
		...
		codigo.sendKeys("54321");
		sleep(1000);

		eventos.sendKeys("Teste Tipo de Arquivo e-Social 2");
		sleep(1000);
