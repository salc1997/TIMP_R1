...
public class TiposDeLotacaoTributariaCriarPO extends TestBase{
	...
	@FindBy(xpath = "//textarea[contains(@placeholder,\"Campo\")]")
	...
	*/
	...
	public TiposDeLotacaoTributariaCriarPO() {
	...
	public boolean criar() {
		...
		codigo.sendKeys("007");
		sleep(1000);
		descricao.sendKeys("Teste Compatibilidade Entre Lotação 7");
		sleep(1000);
		sleep(1000);
		campo.sendKeys("Teste Campo");
		sleep(1000);
		...
		idInserir("TiposDeLotacaoTributaria",idB);
		sleep(2000);
		System.out.println(id);
