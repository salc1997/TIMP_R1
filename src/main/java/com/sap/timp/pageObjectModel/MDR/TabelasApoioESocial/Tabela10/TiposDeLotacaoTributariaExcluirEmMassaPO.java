...
public class TiposDeLotacaoTributariaExcluirEmMassaPO extends TestBase{
	...
	public WebElement preenchimento;
	...
	public TiposDeLotacaoTributariaExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		codigo.sendKeys("123");
		sleep(1000);
		descricao.sendKeys("Teste Tipo de Lotação tributária 1");
		sleep(1000);
		preenchimento.sendKeys("Teste Preenchimento");
		sleep(1000);
		...
		codigo.sendKeys("321");
		sleep(1000);
		descricao.sendKeys("Teste Tipo de Lotação tributária 2");
		sleep(1000);
		preenchimento.sendKeys("Teste Preenchimento");
		sleep(1000);
