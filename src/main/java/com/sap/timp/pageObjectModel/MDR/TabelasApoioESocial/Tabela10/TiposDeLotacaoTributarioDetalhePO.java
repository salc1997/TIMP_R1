...
public class TiposDeLotacaoTributarioDetalhePO extends TestBaseCristhian {
	...
	public WebElement preechimiento;
	...
	public WebElement preechimientoV;
	...
	public TiposDeLotacaoTributarioDetalhePO() {
	...
	public ArrayList<Boolean> detalhes() {
		...
		String preechimientoD1 = preechimiento.getText();
		...
		System.out.println(preechimientoD1);
		...
		String preechimientoV1 = preechimientoV.getText();
		...
		System.out.println(preechimientoV1);
		...
		sucesso.add(preechimientoV1.contains(preechimientoD1));
