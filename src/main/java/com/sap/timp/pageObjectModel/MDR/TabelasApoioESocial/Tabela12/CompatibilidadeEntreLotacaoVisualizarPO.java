...
public class CompatibilidadeEntreLotacaoVisualizarPO extends TestBase{
	...
	@FindBy(xpath = "//td[@id=\"capacityCodeType\"]/span")
	...
	public CompatibilidadeEntreLotacaoVisualizarPO() {
	...
	public ArrayList<Boolean> visualizar() {
		...
		String idRegistro = idObter("CompatibilidadeEntreLotacao");
		...
		String classificacaoE1 = descricaoE.getAttribute("value");
