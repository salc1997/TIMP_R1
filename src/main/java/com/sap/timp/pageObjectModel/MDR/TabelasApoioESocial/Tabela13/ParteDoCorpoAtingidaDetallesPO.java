...
public class ParteDoCorpoAtingidaDetallesPO extends TestBaseMassiel{
	...
	public ParteDoCorpoAtingidaDetallesPO() {
	...
	public ArrayList<Boolean> Detalle() {
		...
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		String idRegistro = idObter("ParteDoCorpoAtingida");
