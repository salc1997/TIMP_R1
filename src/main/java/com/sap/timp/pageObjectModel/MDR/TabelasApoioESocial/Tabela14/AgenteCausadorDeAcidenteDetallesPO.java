package com.sap.timp.pageObjectModel.MDR.TabelasApoioESocial.Tabela14;
...
public class AgenteCausadorDeAcidenteDetallesPO extends TestBaseMassiel{

	@FindBy(xpath = "//span[text()=\"Tabelas de Apoio e-Social\"]")
	public WebElement tabelaApoio;
	
	@FindBy(xpath = "//span[text()=\"Tabela 14 - Agente Causador de Acidente\"]")
	public WebElement tabela14;
	...
	public AgenteCausadorDeAcidenteDetallesPO() {
	...
	public ArrayList<Boolean> Detalle() {
		...
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		String idRegistro = idObter("AgenteCausadorDeAcidente");
