...
public class MotivoDeAfastamentoVisualizarPO extends TestBase{
	...
	public MotivoDeAfastamentoVisualizarPO() {
	...
	public ArrayList<Boolean> visualizar() {
		...
		String idRegistro = idObter("MotivoDeAfastamento");
		...
		String descricaoV1 = classificacaoV.getText();
