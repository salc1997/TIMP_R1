...
public class TiposDeLogradouroExcluirEmMasaPO extends TestBaseSteven {
	...
	public TiposDeLogradouroExcluirEmMasaPO() {
	...
	public boolean criar() {
		...
		codigo.sendKeys("111");
		sleep(1000);
		descricao.sendKeys("Teste Compatibilidade Motivo Desligamento 1");
		sleep(1000);
		...
		codigo.sendKeys("2");
		sleep(1000);
		descricao.sendKeys("Teste Compatibilidade Motivo Desligamento 2");
		sleep(1000);
