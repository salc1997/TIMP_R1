...
public class CodigoDeTreinamentoESimulacoesDeExerciciosDetallesPO extends TestBaseMassiel{
	...
	@FindBy(xpath ="//td[@id=\"simulationTrainingCode\"]/span")
	...
	public CodigoDeTreinamentoESimulacoesDeExerciciosDetallesPO() {
