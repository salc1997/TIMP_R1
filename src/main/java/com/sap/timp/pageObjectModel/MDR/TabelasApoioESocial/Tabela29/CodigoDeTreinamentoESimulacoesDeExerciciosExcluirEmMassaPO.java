...
public class CodigoDeTreinamentoESimulacoesDeExerciciosExcluirEmMassaPO extends TestBaseEliel{
	...
	public CodigoDeTreinamentoESimulacoesDeExerciciosExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		datainicio.sendKeys(dataanterior());
		sleep(1000);
