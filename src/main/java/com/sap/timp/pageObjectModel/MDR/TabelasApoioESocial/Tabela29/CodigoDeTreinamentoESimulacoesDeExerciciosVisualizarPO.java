...
public class CodigoDeTreinamentoESimulacoesDeExerciciosVisualizarPO extends TestBase{
...
public ArrayList<Boolean> visualizar() {
		...
		//pega o ultimo id que foi gerado no criar
		String idRegistro1 = idObter("CodigoDeTreinamentoESimulacoesDeExercicios");
