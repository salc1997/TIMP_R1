...
public class CodigoDeAjusteDaApuraçaoDoIPIExcluirEmMassaPO extends TestBaseEliel {
	...
	public CodigoDeAjusteDaApuraçaoDoIPIExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		descricao.sendKeys("Teste do IPI 1");
