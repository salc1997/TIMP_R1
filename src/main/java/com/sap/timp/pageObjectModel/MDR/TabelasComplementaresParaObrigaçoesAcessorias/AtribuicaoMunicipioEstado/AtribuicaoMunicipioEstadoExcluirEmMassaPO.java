...
public class AtribuicaoMunicipioEstadoExcluirEmMassaPO extends TestBaseEliel{
	...
	public AtribuicaoMunicipioEstadoExcluirEmMassaPO() {
	...
	public boolean criar() {
		...
		opcao.click();
		sleep(1000);
		ibge.sendKeys("1234567");
		descricao.sendKeys("Teste de Atribuição de Municípios por Estado/IBGE");
		codigoMunicipio.sendKeys("1234");
		sleep(1000);
