...
public class TabelaDeCreditoPorObrigacaoEditarPO extends TestBaseEliel{
	...
	public TabelaDeCreditoPorObrigacaoEditarPO() {
	...
	public boolean editar() {
		...
		String valor = codigodecredito.getAttribute("value");

		String enviar = "8";

		codigodecredito.clear();
		sleep(2000);
		codigodecredito.sendKeys(enviar);
		sleep(2000);
		gravar.click();
		sleep(2000);
		...
		waitExpectElement(codigodecredito);
		
		sleep(2000);
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		
		String novoTexto=codigodecredito.getAttribute("value");
		...
		sleep(2000);
		codigodecredito.sendKeys(valor);
