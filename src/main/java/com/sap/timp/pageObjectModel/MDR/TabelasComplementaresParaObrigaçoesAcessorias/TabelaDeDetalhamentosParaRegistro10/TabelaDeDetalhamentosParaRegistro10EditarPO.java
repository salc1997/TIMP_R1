...
public class TabelaDeDetalhamentosParaRegistro10EditarPO extends TestBase{
	...
	public TabelaDeDetalhamentosParaRegistro10EditarPO() {
	...
	public boolean editar() {
		...
		waitExpectedElement(codigododetalhamento);
