...
public class TabelaDeDetalhamentosParaRegistro11CriarPO extends TestBaseEliel {
	...
	public TabelaDeDetalhamentosParaRegistro11CriarPO() {
	...
	public boolean criar() {
		...
		idInserir("TabelaDeDetalhamentoParaRegistro11", id2);
