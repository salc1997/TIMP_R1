...
public class TabelaDeIsencoesEditarPO extends TestBaseEliel{
	...
	public TabelaDeIsencoesEditarPO() {
	...
	public boolean editar() {
		...
		String valor = codigodeisencao.getAttribute("value");

		String enviar = "8";

		codigodeisencao.clear();
		sleep(2000);
		codigodeisencao.sendKeys(enviar);
		sleep(2000);
		gravar.click();
		sleep(2000);
		...
		waitExpectElement(codigodeisencao);
		
		sleep(2000);
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		
		String novoTexto=codigodeisencao.getAttribute("value");
		...
		sleep(2000);
		codigodeisencao.sendKeys(valor);
