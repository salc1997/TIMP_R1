...
public class TabelaDeOutrosCreditosCriarPO extends TestBase{
	...
	public TabelaDeOutrosCreditosCriarPO() {
	...
	public boolean criar() {
		...
		sleep(2000);
		//criaçao
		novocodigodeoutroscreditos.click();
		invisibilityOfElement("//div[@class=\"overlay loader dark\"]");
		sleep(2000);
		...
		sleep(2000);
		codigodeoutroscreditos.sendKeys("7");
		
		sleep(2000);
		
		descricaodeoutroscreditos.sendKeys("Teste");
		...
		idInserir("TabelaDeOutrosCreditos", id2);
