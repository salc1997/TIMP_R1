...
public class TabelaDeProdutosCriarPO extends TestBaseEliel{
	...
	public boolean criar() {
		...
		opcaodescricaoproduto.click();
		
		sleep(2000);
		
		codigoobrigacao.sendKeys("7");
		
		sleep(2000);
		
		descricaoobrigacao.sendKeys("teste");
