...
public class TabelaMunicipioIBGECriarPO extends TestBase{
	...
	public WebElement codigoIBGE;
	
	@FindBy(xpath = "//input[contains(@placeholder,\"Descrição do Município\")]")
	public WebElement descricaoMunicipio;
	...
	*/
	...
	public TabelaMunicipioIBGECriarPO() {
	...
	public boolean criar() {
		...
		codigoIBGE.sendKeys("1234567");
		descricaoMunicipio.sendKeys("Teste de Tabela de Municípios IBGE");
		sleep(1000);
		...
		idInserir("TabelaMunicipioIBGE",idB);
		sleep(2000);
		System.out.println(id);
