...
public class InclusaoDeCamposMarCriarPO extends TestBaseSteven{
	...
	public InclusaoDeCamposMarCriarPO() {
	...
	public boolean criar() {
		...
		idInserir("inclusaodecamposmar", id2);
