...
public class ConfiguracaoEExecucaoExecutarPO extends TestBase{
	...
	public boolean executar() {
		...
		WebElement açao = driver.findElement(By.xpath("//div[@data-id=\""+idRegistroConfiguracaoEExecucao+"\"]//span[text()=\"Executar\"]"));
