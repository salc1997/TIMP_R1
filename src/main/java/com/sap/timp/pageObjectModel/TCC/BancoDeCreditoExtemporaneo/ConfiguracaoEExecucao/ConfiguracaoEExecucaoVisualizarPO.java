...
public class ConfiguracaoEExecucaoVisualizarPO extends TestBase {
	...
	public ArrayList<Boolean> visualizar() {
		...
		WebElement açao = driver.findElement(By.xpath("//div[@data-id=\""+idRegistro+"\"]//span[text()=\"visualizar\"]"));
