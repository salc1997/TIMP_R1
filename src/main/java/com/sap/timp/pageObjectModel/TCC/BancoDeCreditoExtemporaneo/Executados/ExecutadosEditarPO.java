...
public class ExecutadosEditarPO extends TestBase{
	...
	public boolean editar() {
		...
		WebElement açao = driver.findElement(By.xpath("//div[@data-id=\""+idRegistroConfiguracaoEExecucao+"\"]//span[text()=\"Editar\"]"));
