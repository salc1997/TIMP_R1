...
public class Registro1210ExecutarPO extends TestBaseSteven{
	...
	@FindBy(xpath = "//li[@identifier=\"accordion-item-register1210Execution\"]")
	public WebElement executadosregistro1210;
