...
public class RegistroM505EditarPO extends TestBaseEliel{
	...
	public boolean editar() {
		...
		if (tp1 == true || tq1 == true) {
			...
			codigosituacao.clear();
			codigosituacao.sendKeys("08");
			String codigotetexto = codigosituacao.getAttribute("value");
