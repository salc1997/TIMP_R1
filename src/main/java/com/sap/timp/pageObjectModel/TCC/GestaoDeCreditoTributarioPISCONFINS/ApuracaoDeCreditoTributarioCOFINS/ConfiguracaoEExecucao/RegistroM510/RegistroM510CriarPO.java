...
public class RegistroM510CriarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M510\"]")
	...
	public boolean criar() {
		...
		if (naobotao > 0) {
			...
			idInserir("id-GCTPISCOFINS-ACTCOFINSConfiguracaoEExecucacoRegistroM510",id2);
