package com.sap.timp.pageObjectModel.TCC.GestaoDeCreditoTributarioPISCONFINS.ApuracaoDeCreditoTributarioCOFINS.ConfiguracaoEExecucao.RegistroM510;
...
public class RegistroM510EditarPO extends TestBaseEliel {
	...
	@FindBy(xpath = "//li[@identifier=\"accordion-item-registerM510\"]")
	public WebElement registrom510;
	...
	public boolean editar() {
		...
		String idRegistro = idObter("id-GCTPISCOFINS-ACTCOFINSConfiguracaoEExecucacoRegistroM510");
		...
		if (tp1 == true || tq1 == true) {
			...
			opcao.click();
			sleep(2000);
			String indicadortextto = indicador1.getAttribute("value");
			System.out.println("Indicador antes de atualizar:" + indicadortextto);
			...
			System.out.println(" Codigo pós atualizar:" + indicadoratualizada);
			boolean sucesso = false;
			sucesso = indicadoratualizada.contains(indicadortextto);
