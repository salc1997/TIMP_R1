...
public class RegistroM515CriarPO extends TestBaseSteven{
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M515\"]")
	...
	public boolean criar() {
		...
		if (naobotao > 0) {
			...
			idInserir("id-GCTPISCOFINS-ACTCOFINSConfiguracaoEExecucacoRegistroM515",id2);
