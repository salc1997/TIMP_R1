...
public class RegistroM515VisualizarPO extends TestBaseEliel  {
	...
	public RegistroM515VisualizarPO() {
	...
	public ArrayList<Boolean> visualizar() {
		...
		if (tc2 == true) {
			...
			String datavisualizar = dataoperacao.getAttribute("value");
			...
			String dataeditar = dataoperacao.getAttribute("value");
