...
public class RegistroM610VisualizarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor da Base de Cálculo da Contribuição \"]")
	public WebElement valorBase;
	
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor total da contribuição social apurada \"]")
	public WebElement contribuicaoSocialApurada;
	
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor total dos ajustes de acréscimo \"]")
	public WebElement ajustesAcrescimo;
	
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor total dos ajustes de redução \"]")
	public WebElement ajusteReducao;
	
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor total da contribuição do periodo \"]")
