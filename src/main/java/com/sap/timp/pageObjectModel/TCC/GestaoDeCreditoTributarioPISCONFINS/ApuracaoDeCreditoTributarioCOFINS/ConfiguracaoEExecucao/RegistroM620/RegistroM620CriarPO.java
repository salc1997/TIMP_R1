...
public class RegistroM620CriarPO extends TestBaseSteven{
	...
	@FindBy(xpath = "//div[@id=\"indAj\"]/div/div[@id=\"main-icon\"]")
	public WebElement indicadorTipoAjuste;
	
	@FindBy(xpath = "//div[@id=\"vlAj\"]/div/div[@id=\"main-icon\"]")
	public WebElement valorAjuste;
	
	@FindBy(xpath = "//div[@id=\"codAj\"]/div/div[@id=\"main-icon\"]")
	...
	public boolean criar() {
		...
		descricao.sendKeys("TA Registro M620");
		...
		idInserir("GestaoCreditoTributarioCOFINSRegistroM620",id2);
