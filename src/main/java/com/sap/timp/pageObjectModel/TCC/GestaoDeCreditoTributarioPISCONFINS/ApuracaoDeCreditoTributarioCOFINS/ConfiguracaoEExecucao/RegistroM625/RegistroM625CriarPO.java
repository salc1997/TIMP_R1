...
public class RegistroM625CriarPO extends TestBaseSteven{
	...
	@FindBy(xpath = "//div[@id=\"detValorAj\"]/div/div[@id=\"main-icon\"]")
	...
	//	attributeToBeXpath("//div[@id=\"branch\"]/div", "class", "base-MultipleSelect3 required");
		...
		detalhamentoValor.click();
		sleep(1000);
		opcao.click();
		sleep(2000);
		
		dataOperacao.sendKeys(fechaActual());
		
		descricao.sendKeys("TA Registro M625");
		...
		idInserir("GestaoCreditoTributarioCOFINSRegistroM625",id2);
