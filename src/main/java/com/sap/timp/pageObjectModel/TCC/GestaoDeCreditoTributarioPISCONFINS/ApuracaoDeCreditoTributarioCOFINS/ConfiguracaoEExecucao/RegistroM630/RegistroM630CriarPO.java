...
public class RegistroM630CriarPO extends TestBase{
	...
	@FindBy(xpath = "//div[@id=\"vlVend\"]/div/div[@id=\"main-icon\"]")
	public WebElement valorTotalVendasPeriodo;
	
	@FindBy(xpath = "//div[@id=\"vlNaoReceb\"]/div/div[@id=\"main-icon\"]")
	public WebElement valorTotalNaoRecebidoPeriodo;
	
	@FindBy(xpath = "//div[@id=\"vlContDif\"]/div/div[@id=\"main-icon\"]")
	...
	public boolean criar() {
		...
		valorTotalVendasPeriodo.click();
		sleep(1000);
		opcao.click();
		sleep(2000);
		
		valorTotalNaoRecebidoPeriodo.click();
		sleep(1000);
		opcao.click();
		sleep(2000);
		
		valorTotalContribuicaoDiferidaPeriodo.click();
		sleep(1000);
		opcao.click();
		sleep(2000);
