...
public class RegistroM700CriarPO extends TestBaseSteven {
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M700\"]")
	...
	public boolean criar() {
		...
		valorcontribuicaoapurada.click();
		sleep(2000);
		opcao.click();
		sleep(2000);
		valorcontribuicaodiferida.click();
		sleep(2000);
		opcao.click();
		sleep(2000);
		gravar.click();
		...
		if (naobotao > 0) {
			...
			idInserir("GestaoCreditoTributarioPISRegistroM700",id2);
