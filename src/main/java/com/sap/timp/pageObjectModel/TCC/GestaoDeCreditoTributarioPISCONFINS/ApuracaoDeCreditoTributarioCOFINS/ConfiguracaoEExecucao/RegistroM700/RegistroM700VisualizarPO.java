...
public class RegistroM700VisualizarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor da contribuição a recolher diferida em períodos anteriores \"]")
