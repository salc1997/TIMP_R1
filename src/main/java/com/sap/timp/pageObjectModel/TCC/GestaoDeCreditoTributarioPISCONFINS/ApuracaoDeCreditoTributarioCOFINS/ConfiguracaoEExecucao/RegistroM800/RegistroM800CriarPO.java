...
public class RegistroM800CriarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M800\"]")
	...
	public boolean criar() {
		...
		if (naobotao > 0) {
			...
			idInserir("GestaoCreditoTributarioCOFINSRegistroM800",id2);
