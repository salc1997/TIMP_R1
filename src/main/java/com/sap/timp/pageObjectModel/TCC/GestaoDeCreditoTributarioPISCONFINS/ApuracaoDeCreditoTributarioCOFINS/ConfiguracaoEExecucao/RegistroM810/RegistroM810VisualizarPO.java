...
public class RegistroM810VisualizarPO extends TestBaseEliel{
	...
	@FindBy(xpath = "//input[@placeholder=\"Selecionar Valor da receita bruta no período \"]")
	public WebElement valorreceita;
	
	@FindBy(xpath = "//button/span[text()=\"Biblioteca\"]")
	public WebElement biblioteca;
	
	public RegistroM810VisualizarPO() {
	...
	public ArrayList<Boolean> visualizar() {
		...
		String idRegistro = idObter("RegistroM810");
		...
		String naturezaV = natureza.getAttribute("value");
		String valorreceitaV = valorreceita.getAttribute("value");
		...
		System.out.println(naturezaV);
		System.out.println(valorreceitaV);
		...
		String naturezaE = natureza.getAttribute("value");
		String valorreceitaE = valorreceita.getAttribute("value");
		...
		System.out.println(naturezaE);
		System.out.println(valorreceitaE);
		...
		sucesso.add(naturezaE.contains(naturezaV));
		sucesso.add(valorreceitaE.contains(valorreceitaV));
