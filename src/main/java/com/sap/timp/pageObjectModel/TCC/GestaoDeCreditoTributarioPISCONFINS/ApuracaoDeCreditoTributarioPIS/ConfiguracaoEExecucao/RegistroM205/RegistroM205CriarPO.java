...
public class RegistroM205CriarPO extends TestBaseSteven{
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M205\"]")
	...
	@FindBy(xpath = "//div[@id=\"codRec\"]/div/div[2]")
	...
	@FindBy(xpath = "//div[@id=\"vlDebito\"]/div/div[2]")
	...
	//	attributeToBeXpath("//div[@id=\"branch\"]/div", "class", "base-MultipleSelect3 required");
		...
		if (naobotao > 0) {
			...
			idInserir("ApuraçãodeCréditoTributárioPISRegistroM205",id2);
