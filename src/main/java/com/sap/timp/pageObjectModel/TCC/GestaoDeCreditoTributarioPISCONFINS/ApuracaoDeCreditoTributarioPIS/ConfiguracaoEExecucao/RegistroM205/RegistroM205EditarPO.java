...
public class RegistroM205EditarPO extends TestBaseEliel {
	...
	public boolean editar() {
		...
		String idRegistro = idObter("ApuraçãodeCréditoTributárioPISRegistroM205");
		...
		if (tp1 == true || tq1 == true) {
			...
			String enviar="08";
			numerocampo.clear();
			numerocampo.sendKeys(enviar);
			String numerocampotexto = numerocampo.getAttribute("value");
			System.out.println("Numero campo antes de atualizar:" + numerocampotexto);
			...
			String numerocampoatualizada = numerocampo.getAttribute("value");
			System.out.println("Numero campo pós atualizar:" + numerocampoatualizada);
			boolean sucesso = false;
			sucesso = numerocampoatualizada.contains(numerocampotexto);
