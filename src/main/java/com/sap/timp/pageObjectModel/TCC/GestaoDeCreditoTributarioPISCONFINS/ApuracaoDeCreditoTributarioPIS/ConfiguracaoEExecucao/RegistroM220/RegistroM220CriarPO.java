...
public class RegistroM220CriarPO extends TestBaseEliel {
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M220\"]")
	...
	public boolean criar() {
		...
		if (naobotao > 0) {
			...
			idInserir("ApuraçãodeCréditoTributárioPISRegistroM220",id2);
