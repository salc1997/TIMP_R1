...
public class RegistroM220EditarPO extends TestBaseEliel{
	...
	public boolean editar() {
		...
		if (tp1 == true || tq1 == true) {
			...
			opcao.click();
			sleep(1000);
			String indicadorajustetexto = indicadorajuste1.getAttribute("value");
			System.out.println("Numero campo antes de atualizar:" + indicadorajustetexto);
			...
			String indicadorajusteatualizada = indicadorajuste1.getAttribute("value");
			System.out.println("Numero campo pós atualizar:" + indicadorajusteatualizada);
			boolean sucesso = false;
			sucesso = indicadorajusteatualizada.contains(indicadorajustetexto);
