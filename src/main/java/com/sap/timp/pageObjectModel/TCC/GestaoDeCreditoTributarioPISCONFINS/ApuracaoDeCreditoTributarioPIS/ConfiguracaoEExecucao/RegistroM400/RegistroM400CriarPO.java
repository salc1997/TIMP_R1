...
public class RegistroM400CriarPO extends TestBaseEliel {
	...
	@FindBy(xpath = "//span[text()=\"Novo Registro M400\"]")
	...
	@FindBy(xpath = "//div[@id=\"vlTotRec\"]/div/div[2]")
	...
	public boolean criar() {
		...
		if (naobotao > 0) {
			...
			idInserir("ApuraçãodeCréditoTributárioPISRegistroM400",id2);
