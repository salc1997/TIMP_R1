...
public class RegistroM400VisualizarPO extends TestBaseEliel{
	...
	public RegistroM400VisualizarPO() {
	...
	public ArrayList<Boolean> visualizar() {
		...
		String idRegistro = idObter("ApuraçãodeCréditoTributárioPISRegistroM400");
