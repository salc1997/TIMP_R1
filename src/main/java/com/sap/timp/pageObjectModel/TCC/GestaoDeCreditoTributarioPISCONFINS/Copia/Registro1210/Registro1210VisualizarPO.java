package com.sap.timp.pageObjectModel.TCC.GestaoDeCreditoTributarioPISCONFINS.Copia.Registro1210;
...
public class Registro1210VisualizarPO extends TestBaseEliel {
	...
	public ArrayList<Boolean> visualizar() {
		...
		String empresavisualizar = empresa.getAttribute("vlue");
		...
		String empresaeditar = empresa.getAttribute("vlue");
