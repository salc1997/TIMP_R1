...
public class Registro1620EditarPO extends TestBaseEliel{
	...
	public boolean editar() {
		...
		String idRegistro = idObter("GestaoCréditoTributárioCOFINSRegistro1620");
		...
		if (tp1 == true || tq1 == true) {
			...
			System.out.println("Origem pós atualizar:" + origematualizada);
			...
			return sucesso;
				...
				String origematualizada = origem1.getAttribute("value");
				System.out.println("Indicador pós atualizar:" + origematualizada);
				boolean sucesso = false;
				sucesso = origemtexto.contains(origematualizada);
