...
public class Registro1300EditarPO extends TestBaseEliel {
	...
	public boolean editar() {
		...
		if (tp1 == true || tq1 == true) {
			...
			String indicadortexto = indicador1.getAttribute("value");
			System.out.println("Indicador antes de atualizar:" + indicadortexto);
			...
			System.out.println("Indicador pós atualizar:" + indicadoratualizada);
			boolean sucesso = false;
			sucesso = indicadoratualizada.contains(indicadortexto);
			...
			return sucesso;
				...
				String indicadoratualizada = indicador1.getAttribute("value");
				System.out.println("Empres pós atualizar:" + indicadoratualizada);
				boolean sucesso = false;
				sucesso = indicadoratualizada.contains(indicadortexto);
