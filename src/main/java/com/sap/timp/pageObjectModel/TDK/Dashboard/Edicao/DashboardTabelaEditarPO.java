...
public class DashboardTabelaEditarPO extends TestBaseEliel{
	...
	public DashboardTabelaEditarPO() {
		PageFactory.initElements(driver, this);
	}
	
	public ArrayList<Boolean> TabelaEditar() {
		...
		condeudo.click();
		sleep(2000);
		nomepersonalizado.click();
		sleep(2000);
		String enviar2= "Base ICMS";
		etiqueta2.sendKeys(enviar2);
		...
		waitExpectElement(nome);
		sleep(2000);
		String nomeeditado= nome.getAttribute("value");
		...
		condeudo.click();
		sleep(2000);
		String etiquetaeditada=etiqueta2.getAttribute("value");
		System.out.println("Etiqueta editada:"+etiquetaeditada);
		sucesso.add(enviar.contains(nomeeditado));
		sucesso.add(enviar2.contains(etiquetaeditada));
