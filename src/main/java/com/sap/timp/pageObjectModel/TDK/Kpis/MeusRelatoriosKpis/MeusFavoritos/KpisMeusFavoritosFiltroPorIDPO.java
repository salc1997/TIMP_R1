package com.sap.timp.pageObjectModel.TDK.Kpis.MeusRelatoriosKpis.MeusFavoritos;
...
public class KpisMeusFavoritosFiltroPorIDPO extends TestBaseEliel {
	
	@FindBy(xpath = "//span[text()=\"Kpi's\"]")
	public WebElement kpis;
	
	@FindBy(xpath = "//span[text()=\"Meus Relatórios Kpi\"]")
	public WebElement meusrelatorios;
	
	@FindBy(xpath = "//li[@identifier=\"accordion-item-favorite-kpi\"]")
	...
	public KpisMeusFavoritosFiltroPorIDPO() {
