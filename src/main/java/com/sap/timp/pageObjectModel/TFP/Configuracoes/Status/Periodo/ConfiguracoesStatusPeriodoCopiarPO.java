package com.sap.timp.pageObjectModel.TFP.Configuracoes.Status.Periodo;
...
public class ConfiguracoesStatusPeriodoCopiarPO extends TestBase{
	...
	public void copiar() {
		...
		String idRegistro = idObter("ConfiguracoesStatusPeriodo");
