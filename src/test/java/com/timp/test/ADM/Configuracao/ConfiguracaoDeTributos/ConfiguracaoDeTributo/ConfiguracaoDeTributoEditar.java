...
import com.sap.timp.pageObjectModel.ADM.Configuracao.ConfiguracaoDeTributos.ConfiguracaoDeTributo.ConfiguracaoDeTributoEditarPO;

public class ConfiguracaoDeTributoEditar extends TestBase{
	LoginTC loginTC;
