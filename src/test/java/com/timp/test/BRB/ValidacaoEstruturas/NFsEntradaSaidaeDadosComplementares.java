...
public class NFsEntradaSaidaeDadosComplementares extends TestBaseSteven {
	LoginTC loginTC;
	...
	public void beforeClass() {
		...
		nfsEntradaSaidaeDadosComplementaresPO = new NFsEntradaSaidaeDadosComplementaresPO();
	...
	public void verificar() {
		...
		ArrayList<Boolean> sucesso = nfsEntradaSaidaeDadosComplementaresPO.verificar();
