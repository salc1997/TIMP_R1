...
public class AutomacoesMDR2 extends TestBaseSteven{
	...
	// Determinação de Tipo de Condição
		...
		@Test(priority = 22)
		public void hierarquiaDeCenariosDeCorreçaoExcluir() {

			hierarquiaDeCenariosDeCorreçaoEliminar = new hierarquiaDeCenariosDeCorreçaoEliminar();
	...
	/* Bloqueado
		...
		@Test(priority = 24)
		public void iCMSSTTransporteCriar() {

			System.out.println("-------------------Hierarquia De Cenarios De Correção-------------------------");

			iCMSSTTransporteCriar = new ICMSSTTransporteCriar();
			iCMSSTTransporteCriar.beforeClass();
			iCMSSTTransporteCriar.login();
			iCMSSTTransporteCriar.acessarMDR();
			iCMSSTTransporteCriar.criar();
	...
	*/
		...
		/*
		@Test(priority = 38)
		public void livrosFiscaisEditar() {
		...
		*/
		...
		public void parametrosParaLivroICMSSTCriarCriar() {
			...
			System.out.println("-------------------Livros Fiscais > Parametros Para Livro ICMS ST-------------------------");
			...
			System.out.println("-------------------Livros Fiscais > Parametros Para Livro ICMS ST Fin-------------------------");
		}
		...
		/* Bloqueado
		@Test(priority = 52)
		public void mapeamentoDeRelevanciaParaPisCofinsDetalhes() {

			mapeamentoDeRelevanciaParaPisCofinsDetalhes = new mapeamentoDeRelevanciaParaPisCofinsDetalhes();
		...
		*/
		...
		public void tiposDeObjetosDeOcorrenciasFiscaisCriar() {
			...
			System.out.println("-------------------Ocurrencia Fiscal > Tipos De Objetos De Ocorrencias Fiscais-------------------------");
		...
		public void tiposDeObjetosDeOcorrenciasFiscaisDetalhes() {
			...
			System.out.println("-------------------Ocurrencia Fiscal > Tipos De Objetos De Ocorrencias Fiscais Fin-------------------------");
		...
		public void contasDefaultParaExtemporaneoCriar() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Contas Default Para Extemporaneo-------------------------");
		...
		public void contasDefaultParaExtemporaneoExcluir() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Contas Default Para Extemporaneo Fin-------------------------");
		}
		...
		public void contasDefaultPorTributoCriar() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Contas Default Por Tributo-------------------------");
		...
		public void contasDefaultPorTributoExcluir() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Contas Default Por Tributo Fin-------------------------");
		}
		...
		public void mapeamentoContabilCriar() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Mapemaneto Contábil-------------------------");
		...
		public void mapeamentoContabilExcluir() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Mapemaneto Contábil Fin-------------------------");
		}
	...
	//78
		...
		public void mapeamentoContabilCorrecaoCriar() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Mapemaneto Contábil por Correção-------------------------");
		...
		public void mapeamentoContabilCorrecaoVisualizar() {
			...
			System.out.println("-------------------Parâmetros de Contabilização > Mapemaneto Contábil Por Correção Fin-------------------------");
		}
	...
	//84
		...
		public void mapeamentoSubstituicaoContaEstoqueCenariosCorrecoesCriar() {
			...
			System.out.println("-------------------ParametrosContabilizacao > Mapeamento Substituicao Conta Estoque Cenarios Correcoes-------------------------");
		...
		public void mapeamentoSubstituicaoContaEstoqueCenariosCorrecoesExcluir() {
			...
			System.out.println("-------------------ParametrosContabilizacao > Mapeamento Substituicao Conta Estoque Cenarios Correcoes Fin-------------------------");
		}
	...
	//145
		...
		public void motivosCesBeneficiosCriar() {
			...
			System.out.println("------------------- Tabelas de Apoio E-Social > Motivos Ces Beneficios-------------------------");
		...
		public void motivosCesBeneficiosExcluir() {
			...
			System.out.println("------------------- Tabelas de Apoio E-Social > Motivos Ces Beneficios Fin-------------------------");
		}
		...
		public void ajusteEInformaçoesDeValoresExcluir() {
			...
			System.out.println("------------------TabelasApoioSped > Ajustes e Informação de Valores Provenientes de Documento Fiscal Fin-------------------------");
		}
