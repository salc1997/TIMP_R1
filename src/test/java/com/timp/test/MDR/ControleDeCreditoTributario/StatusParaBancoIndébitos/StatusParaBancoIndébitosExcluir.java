...
import com.sap.timp.pageObjectModel.MDR.ControleDeCreditoTributario.StatusParaBancoIndébitos.StatusParaBancoIndébitosExcluirPO;
...
public class StatusParaBancoIndébitosExcluir extends TestBase {
	LoginTC loginTC;
	...
	public void excluir() {
		...
		boolean sucesso = statusParaBancoIndébitosExcluirPO.excluir();
