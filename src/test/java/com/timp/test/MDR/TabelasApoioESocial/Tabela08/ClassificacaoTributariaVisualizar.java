...
public class ClassificacaoTributariaVisualizar extends TestBaseSteven {
	...
	public void beforeClass() {
		...
		classificacaoTributariaVisualizarPO = new ClassificacaoTributariaVisualizarPO();
	}
	...
	public void Visualizar() {
		...
		ArrayList<Boolean> sucesso = classificacaoTributariaVisualizarPO.visualizar();
