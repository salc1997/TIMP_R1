...
import com.sap.timp.pageObjectModel.MDR.TabelasApoioSped.CodigoTipoCredito.InformaçoesAdicionaisDetalhesPO;
...
public class InformaçoesAdicionaisDetalhes extends TestBaseEliel {
	...
	public void Visualizar() {
		...
		String sucesso = informaçoesAdicionaisDetalhesPO.detalhes();
