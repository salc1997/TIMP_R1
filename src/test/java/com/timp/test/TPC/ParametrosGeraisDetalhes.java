...
public class ParametrosGeraisDetalhes extends TestBase {
	LoginTC loginTC;
	AcessarTPCPO acessarTPCPO;
	ParametrosGeraisDetalhesPO parâmetrosGeraisDetalhesPO;
	...
	public void beforeClass() {
		...
		parâmetrosGeraisDetalhesPO = new ParametrosGeraisDetalhesPO();
	}
	...
	public void detalhes() {
		ArrayList<Boolean> sucesso = parâmetrosGeraisDetalhesPO.detalhes();
